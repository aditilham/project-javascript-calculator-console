...
let choose = prompt("Choose calculator you want = 1. Addition 2. Substraction 3. Multiplication 4. Division");
let digitA = prompt("Input first number");
let digitB = prompt("input second number");
switch (choose) {
    case "1":
